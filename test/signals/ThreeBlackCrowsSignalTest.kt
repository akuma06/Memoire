...
import main.signals.ThreeBlackCrowsSignal
import v13.Day
...
class ThreeBlackCrowsSignalTest {

    @Test
    fun update() {
        buildPrices()
        val mm = ThreeBlackCrowsSignal()
    ...
    fun buildPrices(){
        ...
        // Pattern
        PricesList.add(PriceCandle(first=57, last = 54))
        PricesList.add(PriceCandle(first=55, last = 52))
        PricesList.add(PriceCandle(first=53, last = 50))
        // T
    ...
    companion object {
        ...
        fun createDeployment(): JavaArchive {
            return ShrinkWrap.create(JavaArchive::class.java)
                    .addClass(ThreeBlackCrowsSignal::class.java)
